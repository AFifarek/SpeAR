		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAtomicExprAccess().getGroup_2_5(), "rule__AtomicExpr__Group_2_5__0");
					...
					put(grammarAccess.getAtomicExprAccess().getGroup_9_10(), "rule__AtomicExpr__Group_9_10__0");
					...
					put(grammarAccess.getAtomicExprAccess().getCondAssignment_2_2(), "rule__AtomicExpr__CondAssignment_2_2");
					put(grammarAccess.getAtomicExprAccess().getThenAssignment_2_4(), "rule__AtomicExpr__ThenAssignment_2_4");
					put(grammarAccess.getAtomicExprAccess().getElseAssignment_2_5_1(), "rule__AtomicExpr__ElseAssignment_2_5_1");
					put(grammarAccess.getAtomicExprAccess().getAfterAssignment_3_2(), "rule__AtomicExpr__AfterAssignment_3_2");
					put(grammarAccess.getAtomicExprAccess().getUntilAssignment_3_3_1(), "rule__AtomicExpr__UntilAssignment_3_3_1");
					...
					put(grammarAccess.getAtomicExprAccess().getIdsAssignment_9_2(), "rule__AtomicExpr__IdsAssignment_9_2");
					put(grammarAccess.getAtomicExprAccess().getIdsAssignment_9_3_1(), "rule__AtomicExpr__IdsAssignment_9_3_1");
					put(grammarAccess.getAtomicExprAccess().getSpecAssignment_9_7(), "rule__AtomicExpr__SpecAssignment_9_7");
					put(grammarAccess.getAtomicExprAccess().getArgsAssignment_9_9(), "rule__AtomicExpr__ArgsAssignment_9_9");
					put(grammarAccess.getAtomicExprAccess().getArgsAssignment_9_10_1(), "rule__AtomicExpr__ArgsAssignment_9_10_1");

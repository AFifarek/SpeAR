		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAtomicExprAccess().getAfterAssignment_5_2(), "rule__AtomicExpr__AfterAssignment_5_2");
					put(grammarAccess.getAtomicExprAccess().getUntilAssignment_5_3_1(), "rule__AtomicExpr__UntilAssignment_5_3_1");
					put(grammarAccess.getAtomicExprAccess().getCondAssignment_6_2(), "rule__AtomicExpr__CondAssignment_6_2");
					put(grammarAccess.getAtomicExprAccess().getThenAssignment_6_4(), "rule__AtomicExpr__ThenAssignment_6_4");
					put(grammarAccess.getAtomicExprAccess().getTypeAssignment_7_2(), "rule__AtomicExpr__TypeAssignment_7_2");
					put(grammarAccess.getAtomicExprAccess().getFieldExprsAssignment_7_4(), "rule__AtomicExpr__FieldExprsAssignment_7_4");
					put(grammarAccess.getAtomicExprAccess().getFieldExprsAssignment_7_5_1(), "rule__AtomicExpr__FieldExprsAssignment_7_5_1");
